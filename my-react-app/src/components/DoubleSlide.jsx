                ...
                <div className='pb-7'>
                                                                    ...
                                                                    <div className='flex justify-center'>
                                                                        <div className='flex items-center'>
                                                                            ...
                                                                            <div className='mx-4' onClick={() => dispatch(addToCart(item))}>
                                                                                <Link to="/Cart" className=" px-7 py-3 z-10 bg-[#ff497c] text-white font-bold rounded-[4px] relative 
                                                                                before:absolute
                                                                                before:contetn-['']
                                                                                before:px-10
                                                                                before:py-5
                    ...
                    <div>
                        <div className='text-center my-20'>
                            <Link to="ShopNoSidebar" href="#" className=" px-20 py-5 z-10 bg-[#F6F7FB] text-gray-500 font-bold rounded-[4px] relative 
                                before:absolute
                                before:contetn-['']
                                before:px-10
                                before:py-5
